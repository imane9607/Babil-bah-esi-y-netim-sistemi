...
<head>
    ...
    <title>Create Plant - Babil Bahçeleri ve Bitki Yönetim Sistemi</title>
...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $sql = "INSERT INTO plants (name, species, care_instructions, watering_schedule) VALUES ('$name', '$species', '$care_instructions', '$watering_schedule')";

    if ($conn->query($sql) === TRUE) {
        echo "New plant created successfully";
    } else {
        echo "Error: " . $sql . "<br>" . $conn->error;
    }
}

// Tesis oluşturma formu
echo <<<HTML
<div class="container mt-5">
    <h2 class="text-center mb-4"><i class="fas fa-leaf mr-2"></i>Bitki Oluştur</h2>
    <form method="POST" action="">
        ...
        <div class="form-group">
            ...
            <textarea class="form-control" id="care_instructions" name="care_instructions" required></textarea>
        </div>
        <div class="form-group">
            <label for="watering_schedule">Sulama Programı:</label>
            <input type="text" class="form-control" id="watering_schedule" name="watering_schedule" required>
        </div>
