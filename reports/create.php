...
<head>
  ...
  <meta name="description" content="Babil Bahçeleri Yönetim Sistemi - Yeni Rapor Oluştur">
  <meta name="keywords" content="Babil Bahçeleri, yönetim, sistem, raporlar, yeni rapor oluştur">
  <meta name="author" content="Imane Keradi">
  <title>Yeni Rapor Oluştur - Babil Bahçeleri Yönetim Sistemi</title>
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "INSERT INTO reports (report_name, report_date, description) VALUES ('$report_name', '$report_date', '$description')";

    if ($conn->query($sql) === TRUE) {
        echo "<div class='alert alert-success'>Yeni rapor başarıyla oluşturuldu</div>";
    } else {
...
<div class="container mt-5">
  <h2 class="page-title">Yeni Rapor Oluştur</h2>
