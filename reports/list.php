...
<head>
  ...
  <title>Rapor Listesi - Babil Bahçeleri Yönetim Sistemi</title>
...
<div class="container mt-5">
  <h2>Rapor Listesi</h2>
  <div class="mb-3">
    <a href="create.php" class="btn btn-success"><i class="fas fa-plus mr-2"></i>Yeni Rapor Oluştur</a>
  </div>
  <table class="table table-striped table-bordered">
    ...
    <tbody>
      <?php
        ...
        $sql = "SELECT id, report_name, report_date FROM reports";
      ...
      <tr>
        ...
        <td>
          ...
          <a href="delete.php?id=<?php echo $row["id"]; ?>" class="btn btn-danger btn-sm" onclick="return confirm('Bu raporu silmek istediğinize emin misiniz?');"><i class="fas fa-trash-alt"></i></a>
        </td>
      </tr>
      <?php
          }
      ...
      ?>
      <tr><td colspan="3">Hiç rapor bulunamadı</td></tr>
      <?php
        }
      ?>
    </tbody>
