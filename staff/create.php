...
<head>
  ...
  <title>Yeni Personel Oluştur - Babil Bahçeleri Yönetim Sistemi</title>
...
<div class="container mt-5">
  ...
  <?php
    ...
    if ($_SERVER['REQUEST_METHOD'] == 'POST') {
        ...
        $sql = "INSERT INTO staff (name, role, email) VALUES ('$name', '$role', '$email')";

        if ($conn->query($sql) === TRUE) {
            echo '<div class="alert alert-success" role="alert">Yeni personel başarıyla oluşturuldu.</div>';
        } else {
